      ...
      <el-table :data="orderList" border>
        ...
        <el-table-column label="是否付款" prop="order_pay" align="center">
          <template slot-scope="scope">
            <el-tag type="info" v-if="scope.row.order_pay === 1">已付款</el-tag>
        ...
        <el-table-column label="操作" prop align="center">
          <template slot-scope="scope">
            <el-button
              type="primary"
              icon="el-icon-edit"
              @click="editOrderList(scope.row.order_id)"
              size="mini"
            ></el-button>
            <el-button @click="showProgressBox" type="success" icon="el-icon-medal" size="mini"></el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(NewNumId) {
      this.queryInfo.pagenum = NewNumId;
      this.getOrderList();
    },
    editOrderList() {
